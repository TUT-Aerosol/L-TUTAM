function out = coagM3lossTo0Alt(bins,alpha,d1,d2,rho,T,visc,cmd,ln2s)
%UNTITLED5 Summary of this function goes here
%   Detailed explanation goes here
    
    if  d2/d1 > 3
        out = coagM3lossTo0(bins,alpha,d1,d2,rho,T,visc,cmd,ln2s);
        return;
    end
...
%             
%             summa2=summa2+dp2^3*kern*GaussHermiteWeights(j);
%             
%         end
%         
